...
export const ZoneIdSchema = NonBlankStringSchema.brand<'ZoneId'>();
...
export const ScheduleBlockIdSchema = NonBlankStringSchema.brand<'ScheduleBlockId'>();
...
export type ScheduleBlockId = z.infer<typeof ScheduleBlockIdSchema>;
